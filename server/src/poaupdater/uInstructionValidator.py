...
def checkUpgradeActionNaming(instructions):
    ...
    actionBlacklist = []  # list upgrade action that should not be verified against naming conventions
    ...
    errors = {}
    check(instructions.preparation.actions, errors, 240000, 241999)
    check(instructions.pre.actions, errors, 242000, 242999)
    check(instructions.actions, errors, 243000, 245999)
    check(instructions.prepkg.actions, errors, 246000, 246999)
    check(instructions.post.actions, errors, 247000, 248999)
    check(instructions.cleanup.actions, errors, 249000, 249999)
