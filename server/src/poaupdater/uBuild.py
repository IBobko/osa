...
class JBossDistrib:
    def __init__(self):
        ...
        self.pau_db_migration = None  # abs path to pau DB migration folder. Filled if DB migration archive is present in dist/u/pau
...
class Build:
    ...
    def add_pau_db_migration(self, pau_db_migration):
        self.jboss.pau_db_migration = pau_db_migration
