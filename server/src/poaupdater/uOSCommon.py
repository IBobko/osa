...
def _check_java_version(version_str):
    ...
    if ('openjdk' not in version_str) or ('64-bit' not in version_str) or (not re.search('openjdk version \"11\.', version_str)):
        raise uPrecheck.PrecheckFailed('incorrect JDK installed! OpenJDK 11 x64 required.',
