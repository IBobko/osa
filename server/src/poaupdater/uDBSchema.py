...
3. Get table definition from string that is fragment of PDL, with #uPDLDBSchema module """
    ...
    def __init__(self, name, columns, constraints, indexes, referenced_fk=[], triggers=[]):
        self.name = name
    ...
    def reinit(self, con):
        ...
        self.__init__(tab.name, tab.columns, tab.constraints, tab.indexes, tab.referenced_fk, tab.triggers)
...
def dropOwnedBy(con, db_user):
    ...
    return impl.dropOwnedBy(con, db_user)
